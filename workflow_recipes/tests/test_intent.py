...
from workflow_recipes import intent as I
...
class TestMediaTaskModel(unittest.TestCase):
    def test_wan_2_2_image_to_video(self):
        it = I.classify_intent(_graph("video_wan2_2_14B_flf2v"))
    ...
    def test_text_to_image_flux(self):
        it = I.classify_intent(_graph("text_to_image_flux_1_dev"))
    ...
    def test_audio_and_3d(self):
        self.assertEqual(I.classify_intent(_graph("text_to_audio_ace_step_1_5")).media, "audio")
        self.assertEqual(I.classify_intent(_graph("api_meshy_image_to_model")).media, "3d")

    def test_captioning_is_text(self):
        self.assertEqual(I.classify_intent(_graph("image_captioning_gemini")).media, "text")
...
class TestDeterminism(unittest.TestCase):
    def test_stable(self):
        ...
        a = I.classify_intent(g)
        b = I.classify_intent(g)
