...
**Constraints:**
- If the selected template is `Kling3_multiShot`: you MUST activate the `kling-multishot` skill and follow its **Query Templates — Prompt composition** section instead of the rules below. Do NOT use `prompt-craft` for this template.
