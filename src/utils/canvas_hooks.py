    ...
    if standin_hooks:
        ...
        if bake_hooks:
            lines.append(
                ...
                "output_slot, bound in the snippet as in0, in1, … by SLOT NAME — wire "
                "in0 and in2 and the snippet reads in0 and in2, not in0 and in1). Bake "
                "injects an AgentYPython node "
